	...
	<div class="content-cat">
		<ul>
			<?php $args = array( 
			    ...
			    foreach ( $cates as $cate ) {  ?>
					<li>
						<a href="<?php echo get_term_link($cate->slug, 'dia-diem'); ?>"><i class="fa fa-angle-right"></i> <?php echo $cate->name ?></a>
					</li>
			<?php } ?>
		</ul>
	</div>
...
<div class="sale-tour">
	<div class="row">
		<?php $getposts = new WP_query(); $getposts->query('post_status=publish&showposts=2&post_type=tour&meta_key=sale&meta_value>0'); ?>
